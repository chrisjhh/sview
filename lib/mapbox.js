...
export const getTile = (id,z,x,y,params,etag) => get(`/${id}/tiles/${z}/${x}/${y}`,params,etag);
export const cachedGetTile = (cache) => cachify(cache,getTile,'mapbox_api_tile_', 864000);
