...
export class Graph {
  ...
  plot(xdata,ydata) {
    const xscale = (this.max_x - this.min_x) / (this.width - this.margins[1] - this.margins[3]);
    const x = this.margins[3] + (xdata - this.min_x) * xscale;
    const yscale = (this.max_y - this.min_y) / (this.height - this.margins[0] - this.margins[2]);
