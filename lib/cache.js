...
export class InMemoryCache {
   ...
   * @param {function() => undefined} [callback] The optional callback to call when the store is complete.
  */
  store(key,data,expiresIn,callback) {
   ...
   * @param {{(err:Object,data:Object) => undefined}} [callback] - The optional callback to call on completion.
   ...
   * @param {function() => undefined} [callback] The optional callback to call when done
   */
  remove(key, callback) {
